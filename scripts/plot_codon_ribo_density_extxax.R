...
#### plot 1
cairo_pdf('../figures/codondensitydifference_celltypes_extendedxax.pdf', width=6, height=4)
...
diffdata$samplepairs = factor(diffdata$samplepairs,
                              levels=c(
                                ...
                                "leu | gcn2ko"))
#### plot 2
cairo_pdf('../figures/codondensitydifference_gcn2_tor_extendedxax.pdf', width=6, height=4)
p <- ggplot(diffdata, aes(x=position, y=density.diff, color=codon))
(p
  + geom_line()
  + theme_classic()
...
#### plot 3
cairo_pdf('../figures/codondensitydifference_torin_extendedxax.pdf', width=4, height=2)
p <- ggplot(diffdata, aes(x=position, y=density.diff, color=codon))
(p
  + geom_line()
  + theme_classic()
